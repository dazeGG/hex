<template>
  <div class="form">
    <h1 class="form__title">Sign Up Form</h1>
    ...
    <button type="submit" class="form__item form__submit button" @click="submit">Sign Up</button>
    <router-link :to="Routes.authorization" class="form__register">
